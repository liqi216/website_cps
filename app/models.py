...
class GlobalSettings(Document):
	...
	#step14
	alabama = DecimalField()
	louisiana = DecimalField()
	florida = DecimalField()
	mississippi = DecimalField()
	texas = DecimalField()
...
class MseCompFields(EmbeddedDocument):
	...
	#Section 2:
	#Figure 4
	total_SSB_first5mean_mean = FloatField()
	total_SSB_first5mean_upper = FloatField()
	total_SSB_first5mean_lower = FloatField()

	#Figure 5
	total_SSB_last5mean_mean = FloatField()
	total_SSB_last5mean_upper = FloatField()
	total_SSB_last5mean_lower = FloatField()

	#Figure 6
	Forhire_catch_first5mean = FloatField()
	Private_catch_first5mean = FloatField()
	Forhire_catch_last5mean = FloatField()
	Private_catch_last5mean = FloatField()

	#Figure 7
	true_private_AL_catch_first5mean = FloatField()
	true_private_FL_catch_first5mean = FloatField()
	true_private_LA_catch_first5mean = FloatField()
	true_private_MS_catch_first5mean = FloatField()
	true_private_TX_catch_first5mean = FloatField()

	#Figure 8
	true_private_AL_catch_last5mean = FloatField()
	true_private_FL_catch_last5mean = FloatField()
	true_private_LA_catch_last5mean = FloatField()
	true_private_MS_catch_last5mean = FloatField()
	true_private_TX_catch_last5mean = FloatField()

	#Figure 9
	true_private_AL_season_length_first5mean = FloatField()
	true_private_FL_season_length_first5mean = FloatField()
	true_private_LA_season_length_first5mean = FloatField()
	true_private_MS_season_length_first5mean = FloatField()
	true_private_TX_season_length_first5mean = FloatField()

	#Figure 10
	true_private_AL_season_length_last5mean = FloatField()
	true_private_FL_season_length_last5mean = FloatField()
	true_private_LA_season_length_last5mean = FloatField()
	true_private_MS_season_length_last5mean = FloatField()
	true_private_TX_season_length_last5mean = FloatField()

	#Figure 11
	total_catch_first5mean_mean = FloatField()
	total_catch_first5mean_upper = FloatField()
	total_catch_first5mean_lower = FloatField()

	#Figure 12
	total_catch_last5mean_mean = FloatField()
	total_catch_last5mean_upper = FloatField()
	total_catch_last5mean_lower = FloatField()
	...
	comm_catch_first5mean_MSEcomp = FloatField()
	comm_catch_last5mean_MSEcomp = FloatField()
	total_SSB_last5mean_MSEcomp = FloatField()
	comm_disalloratio_ave20_MSEcomp = FloatField()
	comm_disalloratio_ave20_MSEcomp = FloatField()

	#Figure 2
	recr_catch_var_MSEcomp = FloatField()
	Forhire_catch_first5mean_MSEcomp = FloatField()
	Private_catch_first5mean_MSEcomp = FloatField()
	Forhire_catch_last5mean_MSEcomp = FloatField()
	Private_catch_last5mean_MSEcomp = FloatField()
